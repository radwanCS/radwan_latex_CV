...
\begin{document}
	...
	\section{\textbf{Patents and Publications} \hspace*{\fill} \textcolor{darkblue}{\scriptsize C=Conference, J=Journal, P=Patent, R=Preprint, S=In Submission, T=Thesis}}
	\vspace{0.2mm}
	\small{
	...
	\begin{itemize}[leftmargin=*]
		\item Artificial Intelligence (AI) and its applications in healthcare, robotics, and automation
		\item Machine Learning (ML), Deep Learning (DL), and Reinforcement Learning (RL) techniques
		\item Convolutional Neural Networks (CNNs) and Computer Vision for image recognition and processing
		\item Natural Language Processing (NLP) and its impact on language models and chatbots
		\item Algorithm design, optimization, and computational complexity
		\item Autonomous systems, robotics, and intelligent agents
	\end{itemize}
	}
	\vspace{-4mm}
