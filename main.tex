...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{|X|c|c|c|}
		...
		\hline
		Computer Organization \& Architecture & BSc & 1 & Lab\\
		\hline
	...
	\textbullet\ {\normalsize{\textbf{Additional Courses I Can Teach:}}}\\
	\vspace{2mm} % Increased space for better readability
	...
	\begin{tabularx}{\textwidth}{|X|c|}
		\hline
		\rowcolor[HTML]{CCCCCC} % Gray background for header
		\textbf{Course Title} & \textbf{Teaching Readiness} \\
		\hline
		Calculus 1, 2, 3 & Intermediate\\
		\hline
		Computer Programming (C/C++, Java, Python) & Expert\\
		\hline
		Data Structures & Expert\\
		\hline
		Discrete Mathematics & Introductory\\
		\hline
		Digital Logic Design & Introductory\\
		\hline
		Introduction to Information Science \& Technology & Expert\\
		\hline
		...
		Precalculus & Expert\\
		\hline
		System Analysis \& Design & Introductory\\
		\hline
